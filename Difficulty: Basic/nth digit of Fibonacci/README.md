<h2><a href="https://www.geeksforgeeks.org/problems/nth-digit-of-fibonacci1449/0">nth digit of Fibonacci</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">A Fibonacci series (starting from 1) written in order without any spaces in between, thus producing a sequence of digits. Find the nth digit in the sequence.</span><br>
<br>
